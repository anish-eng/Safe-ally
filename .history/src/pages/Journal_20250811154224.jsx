...
const SafeHavenJournal = () => {
  ...
  <h1 className="text-xl sm:text-2xl font-bold text-gray-900 text-center">
    Hello {displayName}! Welcome to Safe Haven
  </h1>

  <div className="max-w-4xl mx-auto">
    <h1 className="text-xl sm:text-2xl font-bold text-gray-900 text-center mt-6">
    ...
    <div className="bg-white rounded-2xl shadow-xl border border-purple-100 p-4 sm:p-6 mb-6 mt-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg sm:text-2xl font-bold text-gray-900">Safe Haven</h1>
    ...
    <div className="bg-white rounded-2xl shadow-xl border border-purple-100 p-4 sm:p-6">
      ...
      <div className="relative mb-6">
        ...
        <div className="absolute bottom-4 left-4 right-4 flex flex-col sm:flex-row sm:items-center sm:justify-start gap-3 flex-wrap">
          ...
          <button
            ...
            className="flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-md hover:scale-105 transform transition w-full sm:w-auto"
          >
      ...
      {/* Audio */}
      {audioUrl && (
        <div className="flex items-center gap-2 mb-6 h-12 flex-wrap">
      ...
      <div className="text-center">
        <button
          onClick={handleSave}
          className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 mt-6 rounded-xl font-medium hover:scale-105 transform transition w-full sm:w-auto"
        >
