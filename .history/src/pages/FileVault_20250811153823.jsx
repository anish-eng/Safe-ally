...
const FileVault = () => {
  ...
  {/* Toolbar */}
  <div className="border-b px-4 sm:px-6 py-3 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 sm:justify-between">
    <div className="flex items-center flex-wrap gap-2 sm:gap-4">
      ...
      <h1 className="text-sm sm:text-base font-medium text-gray-800 truncate max-w-[18rem] sm:max-w-none">
    ...
    <div className="flex items-center flex-wrap gap-2 w-full sm:w-auto">
      ...
      <button
        ...
        className="flex items-center justify-center px-3 py-2 bg-green-600 text-white rounded hover:bg-green-700 w-full sm:w-auto"
      >
  ...
  {/* Breadcrumb */}
  <div className="px-4 sm:px-6 py-3 flex items-center space-x-2 text-sm overflow-x-auto scrollbar-thin">
  ...
  {showNewFolderDialog && (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
      <div className="bg-white rounded-lg p-6 w-full max-w-sm md:w-96">
